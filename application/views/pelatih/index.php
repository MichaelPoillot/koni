    ...
    <div class="animated fadeIn">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <br>
                    <label><a type="button" href="<?= base_url("/pelatih/tambahdata") ?>" class="btn btn-primary btn"><i class="fa fa-pencil-square" aria-hidden="true"></i> Tambah Data</a></label>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pelatih as $p) : ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= $p['no_anggota'] ?></td>
                                    <td class="text-center"><?= $p['nama_pelatih'] ?></td>
                                    <td class="text-center"><?= $p['jenis_kelamin'] ?></td>
                                    <td class="text-center"><?= $p['id_cabor'] ?></td>
                                    <td class="text-center"><?= $p['lesensi'] ?></td>
                                    </td>
                                    <td class="text-center">
                                        <label><button type="button" class="btn btn-success btn-sm" href="<?= base_url(''); ?>pelatih/edit/<?= $p['id_pelatih']; ?>" data-toggle="modal" data-target="#detail"><i class="fa fa-external-link" aria-hidden="true"></i>Detail</button></label>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content modal-lg">
                        ...
                        <div class="card-body">
                            <form action="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $pelatih['no_anggota']; ?>" readonly>
                                </div>
            ...
            <div class="modal-footer">
                <label><a type="button" href="<?= base_url("/pelatih/edit") ?>" class="btn btn-info btn-sm"><i class="menu-icon fa fa-edit"></i>Edit</a></label>
                <label><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete"><i class="menu-icon fa fa-trash"></i>Delete</button></label>
