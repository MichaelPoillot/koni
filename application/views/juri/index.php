    ...
    <div class="animated fadeIn">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <br>
                    <label><a type="button" class="btn btn-primary btn" href="<?= base_url("/juri/tambahdata") ?>"><i class="fa fa-pencil-square" aria-hidden="true"></i> Tambah Data</a></label>
